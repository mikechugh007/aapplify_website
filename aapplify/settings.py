...
JAZZMIN_SETTINGS = {
	"site_title": "AAPPLIFY admin",
	"site_header": "Admin console",
	"site_brand": "Admin console",
	"site_logo": "assets/images/company_logo/aapplify_logo.svg",
	"site_icon": "assets/icons/favicon.svg",
	"welcome_sign": "Welcome to the admin console",
	"copyright": "AAPPLIFY",
	"hide_models": [
		"auth.Group",
		"authentication.User",
		...
		"mainapp.Ticket",
		"mainapp.Message",
		"mainapp.ServiceBooking",
		"mainapp.Plugin",
	],
	"order_with_respect_to": [
		"pitchdeck.PitchDeckAccessLink",
		"pitchdeck.PitchDeck",
	],
}
...
MIDDLEWARE = [
	...
	'aapplify.middlewares.AdminAuthenticatorMFAMiddleware',
...
ADMIN_AUTHENTICATOR_MFA_ENABLED = config("ADMIN_AUTHENTICATOR_MFA_ENABLED", default=True, cast=bool)
