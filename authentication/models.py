...
class User(BaseModel, AbstractBaseUser, PermissionsMixin):
    ...
    admin_totp_secret = models.CharField(_("Admin authenticator secret"), max_length=64, blank=True)
    admin_totp_enabled = models.BooleanField(_("Admin authenticator enabled"), default=False)
    is_active = models.BooleanField(_("Active"), default=True)
    is_staff = models.BooleanField(_("Staff"), default=False)
    is_superuser = models.BooleanField(_("Superuser"), default=False)
    role = models.CharField(_("Role"), max_length=50, choices=ROLES, default=REGULAR_USER)

    credits= models.IntegerField(_("Credits"), default=0, db_column="Credits")
